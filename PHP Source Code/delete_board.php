...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            mysqli_stmt_bind_param($stmt, "s", $param_board_id);
...
<body class="d-flex justify-content-center pt-5">
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?bid=" . $board_id); ?>" method="post">

            <div class="form-group mt-3">
                <input type="submit" class="col-12 btn btn-lg btn-danger me-1 my-1" value="Click">
            </div>

            <p class="text-center mt-2"><a class="text-primary" href="dashboard.php">Cancel</a></p>
