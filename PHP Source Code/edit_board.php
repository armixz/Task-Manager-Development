...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($board_name_err)){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            mysqli_stmt_bind_param($stmt, "sss", $param_bname, $param_bdescription, $param_bid);
    ...
    <div class="card col-3">
        ...
        <div class="card-body d-flex justify-content-center bg-light text-dark rounded"
            ...
            <div class="col-12 wrapper">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?bid=" . $board_id); ?>"
                    method="post">
                    ...
                    <div class="card-footer form-group">
                        ...
                        <p class="text-center mt-2"><a href="dashboard.php" class="text-danger">Cancel</a></p>
                    </div>
